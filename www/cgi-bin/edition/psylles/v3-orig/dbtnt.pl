...
print 	html_header(\%headerHash),
	...
	div({-class=>"wcenter"},
		...
		a({-href=>'/cgi-bin/edition/psylles/v3/dedoublon.pl', -style=>'text-decoration: none; color: darkblue;'},"Merge items"), br, br,

		a({-href=>'/cgi-bin/edition/psylles/v3/fastImage.pl?db=psylles', -style=>'text-decoration: none; color: darkblue;'},"Upload images"), br, br,

		a({-href=>'/cgi-bin/edition/catalogueOfLife.pl?db=psylles', -style=>'text-decoration: none; color: darkblue;'},"Update Catalogue of Life files"), br, br,
