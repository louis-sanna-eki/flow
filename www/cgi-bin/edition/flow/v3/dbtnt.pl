...
print 	html_header(\%headerHash),
	...
	div({-class=>"wcenter"},
		...
		div({-style=>'margin-bottom: 2%; font-size: 18px; font-style: italic;'}, "General tools"),
		
		a({-href=>'/cgi-bin/edition/flow/v3/dedoublon.pl', -style=>'text-decoration: none; color: darkblue;'},"Merge items"), br, br,

		a({-href=>'/cgi-bin/edition/flow/v3/fastImage.pl?db=flow', -style=>'text-decoration: none; color: darkblue;'},"Upload images"), br, br,

		a({-href=>'/cgi-bin/edition/catalogueOfLife.pl?db=flow', -style=>'text-decoration: none; color: darkblue;'},"Update Catalogue of Life files"), br, br,
		
		a({-href=>'display.pl?action=modify', -style=>'text-decoration: none; color: darkblue;'},"Set display modes")
	),
