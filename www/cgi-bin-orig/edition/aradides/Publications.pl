...
use Style qw ($conf_file $background $css $jscript_imgs $jscript_for_hidden $dblabel);
...
sub error_message_maker {
	...
	my %headerHash = ( titre => 'Error', bgcolor => $background );
...
sub redirection {
	...
	my $msg;
	if (param('msg')) { $msg = img({-border=>0, -src=>'/Editor/stop.jpg', -name=>"stop"}) . p . span({-style=>"color: crimson;"}, param('msg')); Delete('msg'); }
	else { $msg = img({-border=>0, -src=>'/Editor/done.jpg', -name=>"done"}) . p . span({-style=>'color: green;'}, "Publication treated") }
		...
		if (!param('pubupdate') and !param('searchTo')) { 
			...
			div({-class=>'wcenter'},
				...
				a(	{-onMouseover=>"nameBack.src=eval('backonimg.src')",
					...
					-onClick=>"backform.action = 'Publications.pl?action=fill&page=pub'; backform.submit();"},
				...
				a(      {href=>"typeSelect.pl?action=add&type=pub"}, "Enter another publication" ),

				p,
				
				a(	{href=>"typeSelect.pl?action=add&type=all"}, "Enter another data" ),
				
				p, br,
				
				a(	{href=>"action.pl", -onMouseOver=>"mM.src=eval('mMonimg.src')",
					-onMouseOut=>"mM.src=eval('mMoffimg.src')"},
					img({-border=>0, -src=>'/Editor/mainMenu1.png', -name=>"mM"})
				)
			).								
			...
			div({-class=>'wcenter'},
				...
				a(	{-onMouseover=>"nameBack.src=eval('backonimg.src')",
					-onMouseout=>"nameBack.src=eval('backoffimg.src')",
					-onClick=>"backform.action = 'Publications.pl?action=modify'; backform.submit();"},
				...
				a(	{ -href=>"typeSelect.pl?action=update&type=all" }, "Modify another data"), p, br,
					
				a(	{ -href=>"action.pl", -onMouseOver=>"mM.src=eval('mMonimg.src')",
					  -onMouseOut=>"mM.src=eval('mMoffimg.src')" },
					  img({-border=>0, -src=>'/Editor/mainMenu1.png', -name=>"mM" }) ), p,
			).
			...
			my %Hash = ( 	jscript => $jscript_imgs . $jscript_for_hidden,
					css => $css,
					bgcolor => $background,
		...
		div({-class=>'wcenter'},
			...
			table({style=>"margin-bottom: 4%;", -cellspacing=>0, cellpadding=>0},
				Tr(
					...
					td({-style=>'background: url(/Editor/pill2.png) repeat-x; color: #FFFFDD; font-size: 18px; font-style: italic;'},"Revue"),
			...
			table({-border=>0},
				Tr(
					td({-align=>'left'},span({-class=>'textLarge'},span({-class=>'textNavy', style=>'padding-right: 10px;'},b("Name")))),
					td({-align=>'left', -style=>'padding-right: 10px;'}, textfield(-class=>'phantomTextField', -name=>'revuename', -style=>'width: 500px;')),
					td({-style=>'padding-right: 10px;'},
						div(	{-onMouseover=>"revueBack.src=eval('backonimg.src')",
							-onMouseout=>"revueBack.src=eval('backoffimg.src')",
							-onClick=>"revueform.action='Publications.pl?action=fill&page=pub'; revueform.submit();"},
							
							img({-border=>0, -src=>'/Editor/back0.png', -name=>"revueBack"})
						)
					),
					td(
						div(	{
							-onMouseover=>"revueOk.src=eval('okonimg.src')",
							-onMouseout=>"revueOk.src=eval('okoffimg.src')",
							-onClick=>"revueform.action='Publications.pl?action=enter&page=revue'; revueform.submit();"},
							
							img({-border=>0, -src=>'/Editor/ok0.png', -name=>"revueOk"})
						)
					)
				)
			)
...
sub edition_form {
	...
	my $city = Tr(
			td({-align=>'left', -style=>'padding-right: 10px; padding-bottom: 25px;'},span({-class=>'textLarge'},span({-class=>'textNavy'},b("City ")))),
			td({-align=>'left', -style=>'padding-bottom: 25px;'},
				table ({-border=>0},Tr(
					td(popup_menu(-class=>'PopupStyle', -name=>"editioncity",-values=>["",@villesorder], -labels=>\%villeslabels)),
					td(
						div( {	-onMouseover=>"newcity.src=eval('newonimg.src')",
							-onMouseout=>"newcity.src=eval('newoffimg.src')",
							-onClick=>"editionform.action='Publications.pl?action=fill&page=city'; editionform.submit();",
							-style=>"position: relative; top: 0px; left: 20px;"},
							
							img ({-name=>'newcity', -src=>'/Editor/new0.png', -border=>0})
						)
					)
				))
			)
	...
	start_form(-name=>'editionform', -method=>'post',-action=>'').
		...
		div({-class=>'wcenter'},
			...
			table({style=>"margin-bottom: 4%;", -cellspacing=>0, cellpadding=>0},
				Tr(
					td({-style=>'background: url(/Editor/pill1.png); width: 14px; height: 26px;'}),
					td({-style=>'background: url(/Editor/pill2.png) repeat-x; color: #FFFFDD; font-size: 18px; font-style: italic;'},"Edition"),
					td({-style=>'background: url(/Editor/pill3.png); width: 14px; height: 26px'})
				)
			),
			...
			table({-border=>0},
				Tr(
					td({-align=>'left', -style=>'padding-right: 10px; padding-bottom: 15px;'},span({-class=>'textLarge'},span({-class=>'textNavy'},b("Edition")))),
				...
				Tr(
					table({-border=>0},
						Tr(
							td({-style=>'padding-right: 10px;'},
								div(	{-onMouseover=>"editionBack.src=eval('backonimg.src')",
									-onMouseout=>"editionBack.src=eval('backoffimg.src')",
									-onClick=>"editionform.action='Publications.pl?action=fill&page=pub'; editionform.submit();"},
									
									img({-border=>0, -src=>'/Editor/back0.png', -name=>"editionBack"})
								)
							),
							td(
								div(	{
									-onMouseover=>"editionOk.src=eval('okonimg.src')",
									-onMouseout=>"editionOk.src=eval('okoffimg.src')",
									-onClick=>"editionform.action='Publications.pl?action=enter&page=edition'; editionform.submit();"},
									
									img({-border=>0, -src=>'/Editor/ok0.png', -name=>"editionOk"})
								)
							)
						)
					)
...
sub city_form {
	...
	my $pays = Tr(
			td({-align=>'left', -style=>'padding-right: 10px; padding-bottom: 25px;'},span({-class=>'textLarge'},span({-class=>'textNavy'},b("Country ")))),
			td({-align=>'left', -style=>'padding-bottom: 25px;'},
				table ({-border=>0},Tr(
					td(popup_menu(-class=>'PopupStyle', -name=>"citycountry",-values=>["",@paysorder], -labels=>\%payslabels)),
					td(
						div( {	-onMouseover=>"newcountry.src=eval('newonimg.src')",
							-onMouseout=>"newcountry.src=eval('newoffimg.src')",
							-onClick=>"	cityform.action='Publications.pl?action=fill&page=country';
									cityform.submit();",
							-style=>"position: relative; top: 0px; left: 20px;"},
							
							img ({-name=>'newcountry', -src=>'/Editor/new0.png', -border=>0})
						)
					)
				))
			)
	...
	start_form(-name=>'cityform', -method=>'post',-action=>'').
		...
		div({-class=>'wcenter'},
			...
			table({style=>"margin-bottom: 4%;", -cellspacing=>0, cellpadding=>0},
				Tr(
					td({-style=>'background: url(/Editor/pill1.png); width: 14px; height: 26px;'}),
					td({-style=>'background: url(/Editor/pill2.png) repeat-x; color: #FFFFDD; font-size: 18px; font-style: italic;'},"City"),
					td({-style=>'background: url(/Editor/pill3.png); width: 14px; height: 26px'})
				)
			),
			...
			table({-border=>0},
				Tr(
					td({-align=>'left', -style=>'padding-right: 10px; padding-bottom: 15px;'},span({-class=>'textLarge'},span({-class=>'textNavy'},b("City")))),
				...
				Tr(
					table({-border=>0},
						Tr(
							td({-style=>'padding-right: 10px;'},
								div(	{-onMouseover=>"cityBack.src=eval('backonimg.src')",
									-onMouseout=>"cityBack.src=eval('backoffimg.src')",
									-onClick=>"cityform.action = 'Publications.pl?action=fill&page=edition'; cityform.submit();"},
									
									img({-border=>0, -src=>'/Editor/back0.png', -name=>"cityBack"})
								)
							),
							td(
								div(	{
									-onMouseover=>"cityOk.src=eval('okonimg.src')",
									-onMouseout=>"cityOk.src=eval('okoffimg.src')",
									-onClick=>"cityform.action = 'Publications.pl?action=enter&page=city'; cityform.submit();"},
									
									img({-border=>0, -src=>'/Editor/ok0.png', -name=>"cityOk"})
								)
							)
						)
					)
	...
	start_form(-name=>'countryform', -method=>'post',-action=>'').
		...
		div({-class=>'wcenter'},
			...
			table({style=>"margin-bottom: 4%;", -cellspacing=>0, cellpadding=>0},
				Tr(
					td({-style=>'background: url(/Editor/pill1.png); width: 14px; height: 26px;'}),
					td({-style=>'background: url(/Editor/pill2.png) repeat-x; color: #FFFFDD; font-size: 18px; font-style: italic;'},"Country"),
					td({-style=>'background: url(/Editor/pill3.png); width: 14px; height: 26px'})
				)
			),
			...
			table({-border=>0},
				Tr(
					td({-align=>'left', -style=>'padding-right: 10px; padding-bottom: 15px;'},span({-class=>'textLarge'},span({-class=>'textNavy'},b("English")))),
					td({-align=>'left', -style=>'padding-bottom: 15px;'}, textfield(-class=>'phantomTextField', -name=>'countryen', -style=>'width: 250px;')),
				),
				
				Tr(
					td({-align=>'left', -style=>'padding-right: 10px; padding-bottom: 15px;'},span({-class=>'textLarge'},span({-class=>'textNavy'},b("French")))),
					td({-align=>'left', -style=>'padding-bottom: 15px;'}, textfield(-class=>'phantomTextField', -name=>'countryfr', -style=>'width: 250px;')),
				),
				
				Tr(
					td({-align=>'left', -style=>'padding-right: 10px; padding-bottom: 15px;'},span({-class=>'textLarge'},span({-class=>'textNavy'},b("Spanish")))),
					td({-align=>'left', -style=>'padding-bottom: 15px;'}, textfield(-class=>'phantomTextField', -name=>'countrysp', -style=>'width: 250px;')),
				),
				
				Tr(
					td({-align=>'left', -style=>'padding-right: 10px; padding-bottom: 15px;'},span({-class=>'textLarge'},span({-class=>'textNavy'},b("German")))),
					td({-align=>'left', -style=>'padding-bottom: 15px;'}, textfield(-class=>'phantomTextField', -name=>'countryde', -style=>'width: 250px;')),
				),
				
				Tr(
					td({-align=>'left', -style=>'padding-right: 10px; padding-bottom: 25px;'},span({-class=>'textLarge'},span({-class=>'textNavy'},b("Portuguese")))),
					td({-align=>'left', -style=>'padding-bottom: 25px;'}, textfield(-class=>'phantomTextField', -name=>'countrypt', -style=>'width: 250px;')),
				),
				
				Tr(
					td({-align=>'left', -style=>'padding-right: 10px; padding-bottom: 25px;'},span({-class=>'textLarge'},span({-class=>'textNavy'},b("Code")))),
				...
				Tr(
					table({-border=>0},
						Tr(
							td({-style=>'padding-right: 10px;'},
								div(	{-onMouseover=>"countryBack.src=eval('backonimg.src')",
									-onMouseout=>"countryBack.src=eval('backoffimg.src')",
									-onClick=>"countryform.action='Publications.pl?action=fill&page=city'; countryform.submit();"},
									
									img({-border=>0, -src=>'/Editor/back0.png', -name=>"countryBack"})
								)
							),
							td(
								div(	{
									-onMouseover=>"countryOk.src=eval('okonimg.src')",
									-onMouseout=>"countryOk.src=eval('okoffimg.src')",
									-onClick=>"countryform.action='Publications.pl?action=enter&page=country'; countryform.submit();"},
									
									img({-border=>0, -src=>'/Editor/ok0.png', -name=>"countryOk"})
								)
							)
						)
					)
...
sub pub_form {
	...
	my $jscript = 	$authorsJscript . $jscript_imgs . $jscript_for_hidden;
	...
	$titre = Tr(
			td({-align=>'left'},span({-class=>'textLarge'},span({-class=>'textNavy'},b("Title ")))),
			td(textfield(-class=>'phantomTextField', -name=>'pubtitle', -style=>'width: 700px;', -onFocus=>AonFocus('pub')))
		);
	
	$annee = Tr(
			td({-align=>'left'},span({-class=>'textLarge'},span({-class=>'textNavy'},b("Year ")))),
			td(textfield(-class=>'phantomTextField', -name=>'pubyear', -maxlength=>4, size=>4, -onFocus=>AonFocus('pub')))
		);
		
	my $pages = Tr(
			td({-align=>'left'},span({-class=>'textLarge'},span({-class=>'textNavy'},b("Pages ")))),
	...
	for (my $i=1;$i<$nbauts;$i++) {
		...
		$authors_field .= Tr(	td({-align=>'left',-valign=>'bottom'},span({-class=>'textLarge'},span({-class=>'textNavy'},b("Author $i ")))),
					td(makeAuthorsfields('pub', $i))
				);
	}
	my $i = $nbauts;
	$authors_field .= Tr(	td({-align=>'left',-valign=>'center'},span({-class=>'textLarge'},span({-class=>'textNavy'},b("Author $i ")))),
				td(
				div({-style=>'position: relative;'},
							makeAuthorsfields('pub', $i).
							div( {-id=>'lessAuts', -onClick=>"ChangeNbAuts(pubform, pubform.pubnbauts, 'less', $nbauts, 'Publications.pl', 'pub');", -style=>'position: absolute; top: 3px; left: 320px;'},img ({-src=>'/Editor/less.png', -border=>0}) ).
							div( {-id=>'moreAuts', -onClick=>"ChangeNbAuts(pubform, pubform.pubnbauts, 'more', $nbauts, 'Publications.pl', 'pub');", -style=>'position: absolute; top: 3px; left: 340px;'},img ({-src=>'/Editor/more.png', -border=>0}) )
					)
				)
			);
	...
	if ($type eq 'Article') {
		...
		$revue = Tr(
				td({-align=>'left'},span({-class=>'textLarge'},span({-class=>'textNavy'},b("Revue ")))),
				td(
					table ({-border=>0},Tr(
						td(popup_menu(-class=>'PopupStyle', -name=>"pubrevue",-values=>["",@revuesorder], -labels=>\%revueslabels, -onFocus=>AonFocus('pub'))),
						td(
							div( {	-onMouseover=>"newrevue.src=eval('newonimg.src')",
								-onMouseout=>"newrevue.src=eval('newoffimg.src')",
								-onClick=>"$form.action = 'Publications.pl?action=fill&page=revue'; $form.submit();",
								-style=>"position: relative; top: 0px; left: 20px;"},
								
								img ({-name=>'newrevue', -src=>'/Editor/new0.png', -border=>0})
							)
						)
					))
				)
		...
		$volume = Tr(
				td({-align=>'left'},span({-class=>'textLarge'},span({-class=>'textNavy'},b("Volume ")))),
				td(textfield(-class=>'phantomTextField', -name=>'pubvol', size=>4, -onFocus=>AonFocus('pub')))
			);
		
		$fascicule = Tr(
				td({-align=>'left'},span({-class=>'textLarge'},span({-class=>'textNavy'},b("Fascicule ")))),
		...
		$edition = Tr(
				td({-align=>'left'},span({-class=>'textLarge'},span({-class=>'textNavy'},b("Edition ")))),
				td(
					table ({-border=>0},Tr(
						td(popup_menu(-class=>'PopupStyle', -name=>"pubedition",-values=>["",@editionorder], -labels=>\%editionlabels, -onFocus=>AonFocus('pub'))),
						td(
							div( {	-onMouseover=>"newedition.src=eval('newonimg.src')",
								-onMouseout=>"newedition.src=eval('newoffimg.src')",
								-onClick=>"$form.action='Publications.pl?action=fill&page=edition'; $form.submit();",
								-style=>"position: relative; top: 0px; left: 20px;"},
								
								img ({-name=>'newedition', -src=>'/Editor/new0.png', -border=>0})
							)
						)
					))
				)
		...
		if (scalar(@{$booklist})) {
			...
			my $bookselect = Tr( 
						td({-align=>'left'},span({-class=>'textLarge'},span({-class=>'textNavy'},b("Book ")))),						
						td(popup_menu(-class=>'PopupStyle', -name=>"bookSid", -values=>["",@sortedids], -labels=>\%pubs, -style=>'font-size: 15px; width: 820px;'))
					).
					Tr(
						td({-align=>'left'},span({-class=>'textLarge'},span({-class=>'textNavy'},b("Or Book id")))),
	...
	if ($backaction) {
		...
		$back = start_form(-name=>'backform', -method=>'post').
			...
			a(	{-onMouseover=>"pubBack.src=eval('backonimg.src')",
				-onMouseout=>"pubBack.src=eval('backoffimg.src')",
				-onClick=>$backaction},
			
				img({-border=>0, -src=>'/Editor/back0.png', -name=>"pubBack"})
			).
	...
	$html .= html_header(\%headerHash).
		...
		div({-class=>'wcenter'},
			...
			table({style=>"margin-bottom: 4%;", -cellspacing=>0, cellpadding=>0},
				Tr(
					td({-style=>'background: url(/Editor/pill1.png); width: 14px; height: 26px;'}),
					td({-style=>'background: url(/Editor/pill2.png) repeat-x; color: #FFFFDD; font-size: 18px; font-style: italic;'},"$type reference"),
					td({-style=>'background: url(/Editor/pill3.png); width: 14px; height: 26px'})
				)
			),
				...
				Tr(td(),td(
					table({-border=>0},
						Tr(
							td(
								div(	{
									-onMouseover=>"pubOk.src=eval('okonimg.src')",
									-onMouseout=>"pubOk.src=eval('okoffimg.src')",
									-onClick=>"$form.action='Publications.pl?action=verify'; $form.submit();"},
									
									img({-border=>0, -src=>'/Editor/ok0.png', -name=>"pubOk"})
								)
							)
						)
					)
			...
			div ({-style=>'margin-top: 3%;'},
				...
				a({ -href=>"action.pl", -onMouseOver=>"mM.src=eval('mMonimg.src')", -onMouseOut=>"mM.src=eval('mMoffimg.src')" },
...
sub recapitulation {
	...
	$back = span(	{-onMouseover=>"pubBack.src=eval('backonimg.src')",
			-onMouseout=>"pubBack.src=eval('backoffimg.src')",
			-onClick=>"pubverif.action='Publications.pl?action=fill&page=pub'; pubverif.submit();"},
	...
	$html .= html_header(\%headerHash).
		...
		div({-class=>'wcenter'},
			...
			table({-border=>0,-width=>1000},Tr(td({-style=>''}, $publi))), br, br,
			
			$back, br, br,
			
			span(	{-onMouseover=>"pubOk.src=eval('okonimg.src')",
				-onMouseout=>"pubOk.src=eval('okoffimg.src')",
				-onClick=>"pubverif.action='$oktgt'; pubverif.submit();"},
