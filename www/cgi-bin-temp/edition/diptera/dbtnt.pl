...
print 	html_header(\%headerHash),
	...
	div({-class=>"wcenter"},
		...
		#a({-href=>'dedoublon.pl', -style=>'text-decoration: none; color: darkblue;'},"Merge items"), br, br,

		#a({-href=>'fastImage.pl?db=flow', -style=>'text-decoration: none; color: darkblue;'},"Upload images"), br, br,

		#a({-href=>'http://hemiptera.infosyslab.fr/cgi-bin/edition/catalogueOfLife.pl?db=flow', -style=>'text-decoration: none; color: darkblue;'},"Update Catalogue of Life files"), br, br,
